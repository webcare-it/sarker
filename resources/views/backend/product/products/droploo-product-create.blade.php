                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{$product['wholesale_price']}}" step="0.01" placeholder="{{ translate('Wholesale price') }}" name="purchase_price" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
